File location: \RTseries\inst\ModuleExamples\RTseriesIntroduction\workshop472_572.R
...
###fit the linear trend seasonal model (using dummy variables allowing
###	different slopes)
...
show.true.acfpacf(model=list(ar=c(0,0,0,0.9)))

show.true.acfpacf(model=list(ar=c(0,0,0.5)))
